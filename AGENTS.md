...
- La pestaña Agrocalidad tiene **dos sub-pestañas** (patron `.subtabs`/`.subpanel` que ya usan inventario-lag y torre-control): "Consulta de requisitos" y "Agrocalidad vs Ventas vs VUE". La comparacion hoy es **solo por especie** y lo dice en pantalla: falta el pais en las ventas (la columna existe pero aun no hay datos importados) y VUE no tiene ningun dato cargado. Hallazgo del cruce: **BOUQUETS factura $2.037.431 —el primero por lejos— y no tiene mapeo en Agrocalidad** por ser producto compuesto y no una especie
